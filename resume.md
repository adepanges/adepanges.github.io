...
* **Mobile:** +6282322254063
* **Email:** adepanges@gmail.com
* **LinkedIn:** www.linkedin.com/in/adepanges 
...
Ade Pangestu is a Full-Stack Developer with over 9 years of experienc 3]. He specializes in Node.js, TypeScript, and PHP, and is also an explorer of Cloud & AI technologie He has a proven track record of building scalable web applications, optimizing systems, and delivering cloud-native solutions across various industries such as e-commerce, telecom, and Saa Ade is proficient in frameworks like Laravel and CodeIgniter, modern frontend tools (Vue.js, React), database design (PostgreSQL, MongoDB), and performance tunin He is currently expanding his expertise into Cloud Operations (AWS) and integrating AI-driven features into production systems, focusing on workflow automation and user personalizatio He is passionate about combining cutting-edge tools like machine learning with robust engineering practices, emphasizing clean code, Agile methodologies, and end-to-end project ownershi
...
* Seminar Internet of Thing and Big Data "Build Your Creativity With Intelegence" 
* Izin Komunikasi Radio Antar Penduduk (IKRAP) - JZ11CEU 
...
* **Key Strengths:**
    * Full-Stack Expertise: Node.js, TypeScript, PostgreSQL/SQL Server, Pug, KnockoutJS.
    * Performance Focus: Database optimization, indexing, and latency reduction.
    * Client Collaboration: Delivering tailored solutions for international clients like GroupMap Technology Pty Ltd.
    * Modern Practices: Agile/Scrum, CI/CD, AWS, and test-driven development (TDD).
...
* **Total Duration:** 2 years 7 months
    ...
    * **Duration:** January 2019 - February 2021 (2 years 2 months)
    * **Location:** Provinsi Yogyakarta, Indonesia
    * **Responsibilities:**
    ...
    * **Duration:** August 2018 - December 2018 (5 months)
    * **Location:** Provinsi Yogyakarta, Indonesia
    * **Responsibilities:**
...
* **Duration:** February 2018 - July 2018 (6 months)
* **Location:** Jakarta
* **Responsibilities:**
...
* **Duration:** March 2017 - February 2018 (1 year)
* **Location:** Jakarta
* **Responsibilities:**
...
* **Duration:** May 2015 - February 2017 (1 year 10 months)
* **Location:** Jakarta
* **Responsibilities:**
